...
namespace BirdsiteLive.DAL.Postgres.DataAccessLayers
{
    ...
    public class DbInitializerPostgresDal : PostgresBase, IDbInitializerDal
    {
        ...
        private readonly Version _currentVersion = new Version(4, 2);
        ...
        public Tuple<Version, Version>[] GetMigrationPatterns()
        {
            return new[]
            {
                ...
                new Tuple<Version, Version>(new Version(4,1), new Version(4,2)),
            };
        }
        ...
        public async Task<Version> MigrateDbAsync(Version from, Version to)
        {
            ...
            else if (from == new Version(4, 1) && to == new Version(4, 2))
            {
                var alterHnAddDefault = $@"ALTER TABLE {_settings.HackerNewsUserTableName} ALTER COLUMN type SET DEFAULT 'u'";
                await _tools.ExecuteRequestAsync(alterHnAddDefault);
            }
            else
            {
