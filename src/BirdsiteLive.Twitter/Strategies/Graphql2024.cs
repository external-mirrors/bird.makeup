...
public class Graphql2024 : ITweetExtractor, ITimelineExtractor
{
    ...
    public Graphql2024(ITwitterAuthenticationInitializer twitterAuthenticationInitializer, ITwitterTweetsService tweetsService, IHttpClientFactory httpClientFactory, InstanceSettings instanceSettings, ILogger<TwitterTweetsService> logger)
    {
